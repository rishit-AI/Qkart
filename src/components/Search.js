...
class Search extends React.Component {
  ...
  search = (text) => {
    console.log("search");
    var sub=(this.products).filter(function(items) {
      return items.name.toUpperCase().includes(text.toUpperCase()) 
      || items.category.toUpperCase().includes(text.toUpperCase()) ;
    });
    this.setState({
        ...
        <Product
          ...
          addToCart={async() => {
            if (this.state.loggedIn) {
              ...
              await this.cartRef.current.pushToCart(product._id,1,true);
    ...
    return (
      <>
        ...
        <Header history={this.props.history}>
          ...
          <Input.Search placeholder="input search text" onChange={this.debounceSearch} onSearch={this.search}  enterButton style={{ width: 200 }} />,
        </Header>
          ...
          {this.state.loggedIn && this.products.length && (
            ...
            >
              <div>
                ...
                <Cart history={this.props.history} ref={this.cartRef} products={this.products} checkout={false}></Cart>
              </div>
            </Col>
          )}
        </Row>
